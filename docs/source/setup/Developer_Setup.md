...
For an example setup of this directory, see the [Sample](https://github.com/zipline-ai/chronon/tree/main/api/python/test/sample) that is also mounted to the docker image that is used in the Quickstart guide.
