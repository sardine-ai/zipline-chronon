...
metadata is extracted from [teams.json](https://github.com/zipline/chronon/blob/main/api/python/test/sample/teams.json) (or default team if one is not set).

**[See more configuration examples here](https://github.com/zipline/chronon/blob/main/api/python/test/sample/staging_queries)**
