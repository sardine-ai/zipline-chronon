...
[Chaining GroupBy](https://github.com/zipline/chronon/blob/main/api/python/test/sample/group_bys/sample_team/sample_chaining_group_by.py)

[Chaining Join](https://github.com/zipline/chronon/blob/main/api/python/test/sample/joins/sample_team/sample_chaining_join.py)
