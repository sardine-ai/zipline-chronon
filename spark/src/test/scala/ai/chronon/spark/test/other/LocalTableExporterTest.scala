...
import ai.chronon.spark.test.other.LocalTableExporterTest.spark
import ai.chronon.spark.test.other.LocalTableExporterTest.tmpDir
...
object LocalTableExporterTest {
  ...
  val spark: SparkSession =
    SparkSessionBuilder.build("LocalTableExporterTest", local = true, localWarehouseLocation = Some(tmpDir.getPath))
