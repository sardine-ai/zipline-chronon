...
class Analyzer(tableUtils: TableUtils,
  ...
  def analyzeGroupBy(groupByConf: api.GroupBy,
    ...
    val timestampChecks = Validator.runTimestampChecks(groupBy.inputDf)
    Validator.validateTimestampChecks(timestampChecks, "GroupBy", name)
  ...
  def analyzeJoin(joinConf: api.Join,
    ...
    val timestampChecks = Validator.runTimestampChecks(leftDf)
    Validator.validateTimestampChecks(timestampChecks, "Join", name)
