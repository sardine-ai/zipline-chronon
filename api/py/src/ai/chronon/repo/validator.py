...
import os
import re
from gen_thrift.api.ttypes import GroupBy, Join, Source, Derivation, ExternalPart
from ai.chronon.group_by import get_output_col_names
from ai.chronon.logger import get_logger
from ai.chronon.repo.constants import JOIN_FOLDER_NAME, GROUP_BY_FOLDER_NAME
from ai.chronon.repo.serializer import thrift_simple_json, file2thrift
...
class ChrononRepoValidator(object):
    def __init__(
        self, chronon_root_path: str, output_root: str, log_level=logging.INFO
    ):
    ...
    def load_objs(self):
        ...
        self.old_group_bys = extract_json_confs(
            GroupBy,
            os.path.join(
                self.chronon_root_path, self.output_root, GROUP_BY_FOLDER_NAME
            ),
        )
