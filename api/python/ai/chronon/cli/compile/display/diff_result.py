...
class DiffResult:
    ...
    def __init__(self):
        ...
        self.version_bumped: List[Tuple[str, int, int]] = []  # (base_name, old_version, new_version)
    ...
    def detect_version_changes(self, deleted_names: List[str]) -> Tuple[List[str], List[str]]:
        ...
        for name in deleted_names:
            ...
            if (base_name in added_base_to_name and 
                old_version is not None and 
                base_name in deleted_base_to_name):
