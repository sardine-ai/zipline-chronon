...
public class PartialThriftComparer<T extends TBase> {
  ...
  private ai.chronon.api.thrift.partial.ThriftMetadata.ThriftStruct metadata;
   ...
   */
  public PartialThriftComparer(ai.chronon.api.thrift.partial.ThriftMetadata.ThriftStruct metadata) {
  ...
  private boolean areEqual(
          ai.chronon.api.thrift.partial.ThriftMetadata.ThriftObject data, Object o1, Object o2, StringBuilder sb) {

    byte fieldType = data.data.valueMetaData.type;
    switch (fieldType) {
      case TType.STRUCT:
        return this.areEqual((ai.chronon.api.thrift.partial.ThriftMetadata.ThriftStruct) data, o1, o2, sb);

      case TType.LIST:
        return this.areEqual((ai.chronon.api.thrift.partial.ThriftMetadata.ThriftList) data, o1, o2, sb);

      case TType.MAP:
        return this.areEqual((ai.chronon.api.thrift.partial.ThriftMetadata.ThriftMap) data, o1, o2, sb);

      case TType.SET:
        return this.areEqual((ai.chronon.api.thrift.partial.ThriftMetadata.ThriftSet) data, o1, o2, sb);

      case TType.ENUM:
        return this.areEqual((ai.chronon.api.thrift.partial.ThriftMetadata.ThriftEnum) data, o1, o2, sb);
      ...
      case TType.DOUBLE:
      case TType.STRING:
        return this.areEqual((ai.chronon.api.thrift.partial.ThriftMetadata.ThriftPrimitive) data, o1, o2, sb);
  ...
  private boolean areEqual(
          ai.chronon.api.thrift.partial.ThriftMetadata.ThriftStruct data, Object o1, Object o2, StringBuilder sb) {
    ...
    if (data.fields.size() == 0) {
      ...
      for (Object o : data.fields.values()) {
        ai.chronon.api.thrift.partial.ThriftMetadata.ThriftObject field = (ai.chronon.api.thrift.partial.ThriftMetadata.ThriftObject) o;
  ...
  private boolean areEqual(
          ai.chronon.api.thrift.partial.ThriftMetadata.ThriftPrimitive data, Object o1, Object o2, StringBuilder sb) {
  ...
  private boolean areEqual(ai.chronon.api.thrift.partial.ThriftMetadata.ThriftEnum data, Object o1, Object o2, StringBuilder sb) {
  ...
  private boolean areEqual(ai.chronon.api.thrift.partial.ThriftMetadata.ThriftList data, Object o1, Object o2, StringBuilder sb) {
  ...
  private boolean areEqual(ai.chronon.api.thrift.partial.ThriftMetadata.ThriftSet data, Object o1, Object o2, StringBuilder sb) {
  ...
  private boolean areEqual(ai.chronon.api.thrift.partial.ThriftMetadata.ThriftMap data, Object o1, Object o2, StringBuilder sb) {
  ...
  private void appendResult(
          ai.chronon.api.thrift.partial.ThriftMetadata.ThriftObject data, StringBuilder sb, String format, Object... args) {
    if (sb != null) {
  ...
  private void appendNotEqual(
      ai.chronon.api.thrift.partial.ThriftMetadata.ThriftObject data,
      StringBuilder sb,
      Object o1,
      Object o2,
      String o1name,
