...
import ai.chronon.api.thrift.TBaseHelper;
...
import ai.chronon.api.thrift.scheme.SchemeFactory;
...
public abstract class TUnion<T extends TUnion<T, F>, F extends TFieldIdEnum>
    implements ai.chronon.api.thrift.TBase<T, F> {
  ...
  private static Object deepCopyObject(Object o) {
    if (o instanceof ai.chronon.api.thrift.TBase) {
