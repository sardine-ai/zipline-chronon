...
import ai.chronon.api.thrift.protocol.TProtocolDecorator;
 ...
 * ai.chronon.api.thrift.TMultiplexedProcessor TMultiplexedProcessor} to handle requests from a
 * multiplexing client.
 *
 ...
 * }</pre>
 *
 * @see ai.chronon.api.thrift.protocol.TProtocolDecorator
 */
public class TMultiplexedProtocol extends TProtocolDecorator {
  ...
  public void writeMessageBegin(ai.chronon.api.thrift.protocol.TMessage tMessage) throws TException {
    if (tMessage.type == ai.chronon.api.thrift.protocol.TMessageType.CALL || tMessage.type == TMessageType.ONEWAY) {
