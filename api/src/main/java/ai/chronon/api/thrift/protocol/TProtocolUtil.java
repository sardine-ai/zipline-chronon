...
public class TProtocolUtil {
   ...
   */
  public static void skip(ai.chronon.api.thrift.protocol.TProtocol prot, byte type) throws TException {
    ...
    switch (type) {
      ...
      case ai.chronon.api.thrift.protocol.TType.STRUCT:
        ...
        while (true) {
          ...
          if (field.type == ai.chronon.api.thrift.protocol.TType.STOP) {
            break;
          }
