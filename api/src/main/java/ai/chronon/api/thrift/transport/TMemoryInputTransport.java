...
public final class TMemoryInputTransport extends TEndpointTransport {
  ...
  public TMemoryInputTransport() throws ai.chronon.api.thrift.transport.TTransportException {
    this(new TConfiguration());
  }

  public TMemoryInputTransport(TConfiguration _configuration) throws ai.chronon.api.thrift.transport.TTransportException {
    this(_configuration, new byte[0]);
  }

  public TMemoryInputTransport(byte[] buf) throws ai.chronon.api.thrift.transport.TTransportException {
  ...
  public TMemoryInputTransport(byte[] buf, int offset, int length) throws ai.chronon.api.thrift.transport.TTransportException {
  ...
  public void reset(byte[] buf, int offset, int length) {
    ...
    } catch (ai.chronon.api.thrift.transport.TTransportException e) {
      // ignore
    }
  }
