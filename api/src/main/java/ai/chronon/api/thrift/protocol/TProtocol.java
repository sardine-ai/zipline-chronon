...
import ai.chronon.api.thrift.protocol.*;
...
import ai.chronon.api.thrift.scheme.StandardScheme;
...
public abstract class TProtocol implements TWriteProtocol, TReadProtocol {
  ...
  protected void checkReadBytesAvailable(ai.chronon.api.thrift.protocol.TMap map) throws TException {
  ...
  protected void checkReadBytesAvailable(ai.chronon.api.thrift.protocol.TList list) throws TException {
    long size = list.getSize();
    trans_.checkReadBytesAvailable(size * getMinSerializedSize(list.elemType));
  }

  protected void checkReadBytesAvailable(ai.chronon.api.thrift.protocol.TSet set) throws TException {
  ...
  public final <T> void writeSet(byte elementType, Set<T> set, WriteCallback<T> callback)
      throws TException {
    writeSetBegin(new ai.chronon.api.thrift.protocol.TSet(elementType, set.size()));
    for (T t : set) {
      callback.call(t);
    }
    writeSetEnd();
  ...
  public final <T> void writeList(byte elementType, List<T> list, WriteCallback<T> callback)
      throws TException {
    writeListBegin(new ai.chronon.api.thrift.protocol.TList(elementType, list.size()));
    for (T t : list) {
      callback.call(t);
    }
    writeListEnd();
  ...
  public final <K, V> void writeMap(
      ...
      throws TException {
    writeMapBegin(new ai.chronon.api.thrift.protocol.TMap(keyType, valueType, map.size()));
  ...
  public final void writeField(ai.chronon.api.thrift.protocol.TField field, WriteCallback<Void> callback) throws TException {
    writeFieldBegin(field);
    callback.call(null);
    writeFieldEnd();
  }

  public final void writeStruct(ai.chronon.api.thrift.protocol.TStruct struct, WriteCallback<Void> callback) throws TException {
    writeStructBegin(struct);
    callback.call(null);
    writeStructEnd();
  }

  public final void writeMessage(ai.chronon.api.thrift.protocol.TMessage message, WriteCallback<Void> callback) throws TException {
   ...
   */
  public final <T> T readMessage(ReadCallback<ai.chronon.api.thrift.protocol.TMessage, T> callback) throws TException {
   ...
   * @throws TException when any sub-operation failed
   */
  public final <T> T readStruct(ReadCallback<ai.chronon.api.thrift.protocol.TStruct, T> callback) throws TException {
   ...
   * #readFieldEnd() end} automatically, and returns whether the {@link ai.chronon.api.thrift.protocol.TType#STOP stop signal} was
   ...
   */
  public final <T> boolean readField(ReadCallback<ai.chronon.api.thrift.protocol.TField, T> callback) throws Exception {
    ai.chronon.api.thrift.protocol.TField tField = readFieldBegin();
    if (tField.type == ai.chronon.api.thrift.protocol.TType.STOP) {
      return true;
    }
   ...
   */
  public final <T extends Map<?, ?>> T readMap(ReadCallback<ai.chronon.api.thrift.protocol.TMap, T> callback) throws TException {
    ai.chronon.api.thrift.protocol.TMap tMap = readMapBegin();
   ...
   * @throws TException when any sub-operation fails
   */
  public final <T extends List<?>> T readList(ReadCallback<ai.chronon.api.thrift.protocol.TList, T> callback) throws TException {
    ai.chronon.api.thrift.protocol.TList tList = readListBegin();
   ...
   * @throws TException when any sub-operation fails
   */
  public final <T extends Set<?>> T readSet(ReadCallback<ai.chronon.api.thrift.protocol.TSet, T> callback) throws TException {
    ai.chronon.api.thrift.protocol.TSet tSet = readSetBegin();
    ...
    switch (fieldType) {
      ...
      case ai.chronon.api.thrift.protocol.TType.STRUCT:
        ...
        while (true) {
          ...
          if (tfieldType == ai.chronon.api.thrift.protocol.TType.STOP) {
            break;
          }
