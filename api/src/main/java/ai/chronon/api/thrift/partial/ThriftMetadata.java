...
package ai.chronon.api.thrift.partial;
...
import ai.chronon.api.thrift.TFieldRequirementType;
import ai.chronon.api.thrift.TUnion;
import ai.chronon.api.thrift.meta_data.FieldMetaData;
import ai.chronon.api.thrift.meta_data.ListMetaData;
import ai.chronon.api.thrift.meta_data.MapMetaData;
import ai.chronon.api.thrift.meta_data.SetMetaData;
import ai.chronon.api.thrift.meta_data.StructMetaData;
import ai.chronon.api.thrift.partial.EnumCache;
import ai.chronon.api.thrift.partial.ThriftField;
...
public class ThriftMetadata {
  ...
  public abstract static class ThriftObject implements Serializable {
    ...
    public static class Factory {
      ...
      static ThriftObject createNew(
          ThriftObject parent, TFieldIdEnum fieldId, FieldMetaData data, List<ai.chronon.api.thrift.partial.ThriftField> fields) {
  ...
  public static class ThriftEnum extends ThriftObject {
    private static ai.chronon.api.thrift.partial.EnumCache enums = new EnumCache();
  ...
  public abstract static class ThriftStructBase<U extends TBase> extends ThriftObject {
    ...
    public static ThriftStructBase create(
        ...
        FieldMetaData data,
        Iterable<ai.chronon.api.thrift.partial.ThriftField> fieldsData) {
  ...
  public static class ThriftStruct<U extends TBase> extends ThriftStructBase {
    ...
    public static <T extends TBase> ThriftStruct fromFieldNames(
      ...
      return fromFields(clasz, ai.chronon.api.thrift.partial.ThriftField.fromNames(fieldNames));
    }

    public static <T extends TBase> ThriftStruct fromFields(
        Class<T> clasz, Iterable<ai.chronon.api.thrift.partial.ThriftField> fields) {

      ai.chronon.api.thrift.partial.Validate.checkNotNull(clasz, "clasz");
    ...
    private static <U extends TBase> Map<Integer, ThriftObject> getFields(
        ThriftStruct parent, Class<U> clasz, Iterable<ai.chronon.api.thrift.partial.ThriftField> fieldsData) {
      ...
      if (getAllFields) {
        ...
        for (ThriftField fieldData : fieldsData) {
          ...
          ThriftObject field =
              Factory.createNew(parent, fieldId, fieldMetaData, fieldData.fields);
          fields.put((int) fieldId.getThriftFieldId(), field);
        }
      }
